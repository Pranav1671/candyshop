...
p=PhotoImage(file='darkchocolate1.png')
bb2=Label(image=p)
bb2.place(x=60,y=60)
'''
...
lb3=Label(win1,text='MRP  : Rs. 140.00 /-',font=('copper',20,'bold'))
lb3.place(x=360,y=30)
lb4=Label(win1,text='Expiry Date  : NOV/24 ',font=('copper',20,'bold'))
lb4.place(x=360,y=70)
lb5=Label(win1,text='MFD  : AUG/22 ',font=('copper',20,'bold'))
lb5.place(x=360,y=110)
lb6=Label(win1,text='Inclusive of All Taxes ',font=('copper',20,'bold'))
lb6.place(x=360,y=150)
lb7=Label(win1,text='A Product By Amul',font=('copper',20,'bold'))
...
btt1.bind('<Button-1>',lambda e:callback('https://amul.com/products/amul-dark-chocolate-info.php'))
