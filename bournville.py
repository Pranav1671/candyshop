...
p=PhotoImage(file='bournville1.png')
bb2=Label(image=p)
bb2.place(x=80,y=60)
'''
...
lb3=Label(win1,text='MRP  : Rs. 150.00 /-',font=('copper',20,'bold'))
lb3.place(x=360,y=30)
lb4=Label(win1,text='Expiry Date  : NOV/23 ',font=('copper',20,'bold'))
lb4.place(x=360,y=70)
lb5=Label(win1,text='MFD  : SEP/22 ',font=('copper',20,'bold'))
...
btt1.bind('<Button-1>',lambda e:callback('https://www.cadbury.co.uk/products/cadbury-bournville-11314'))
