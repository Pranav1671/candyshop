...
p=PhotoImage(file='fabelle1.png')
bb2=Label(image=p)
bb2.place(x=60,y=60)
'''
...
lb3=Label(win1,text='MRP  : Rs. 1500.00 /-',font=('copper',20,'bold'))
lb3.place(x=360,y=30)
lb4=Label(win1,text='Expiry Date  : AUG/23 ',font=('copper',20,'bold'))
...
btt1.bind('<Button-1>',lambda e:callback('https://fabelle.in/'))
