...
lb1=Label(win1,image=ph1)
lb1.place(x=0,y=0)

p=PhotoImage(file='whittakershazelnut1.png')
bb2=Label(win1,image=p)
bb2.place(x=60,y=30)
'''
...
lb3=Label(win1,text='MRP  : Rs. 899.00 /-',font=('copper',20,'bold'))
lb3.place(x=360,y=30)
lb4=Label(win1,text='Expiry Date  : APL/23 ',font=('copper',20,'bold'))
lb4.place(x=360,y=70)
lb5=Label(win1,text='MFD  : NOV/22 ',font=('copper',20,'bold'))
lb5.place(x=360,y=110)
lb6=Label(win1,text='Inclusive of All Taxes ',font=('copper',20,'bold'))
lb6.place(x=360,y=150)
lb7=Label(win1,text="A Product By Whittaker's",font=('copper',20,'bold'))
...
btt1.bind('<Button-1>',lambda e:callback('https://www.whittakers.co.nz/en_WW/products/hazelnut/block-250g'))
