...
p=PhotoImage(file='milkybarclassic1.png')
bb2=Label(image=p)
bb2.place(x=40,y=80)
'''
...
lb3=Label(win1,text='MRP  : Rs. 15.00 /-',font=('copper',20,'bold'))
lb3.place(x=360,y=30)
lb4=Label(win1,text='Expiry Date  : DEC/22 ',font=('copper',20,'bold'))
lb4.place(x=360,y=70)
lb5=Label(win1,text='MFD  : JAN/22 ',font=('copper',20,'bold'))
...
btt1.bind('<Button-1>',lambda e:callback('https://www.milkybar.co.uk/'))
