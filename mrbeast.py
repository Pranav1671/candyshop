...
p=PhotoImage(file='mrbeast1.png')
...
lb3=Label(win1,text='MRP  : Rs. 3500.00 /-',font=('copper',20,'bold'))
lb3.place(x=360,y=30)
lb4=Label(win1,text='Expiry Date  : JUN/23 ',font=('copper',20,'bold'))
lb4.place(x=360,y=70)
lb5=Label(win1,text='MFD  : MAR/22 ',font=('copper',20,'bold'))
...
btt1.bind('<Button-1>',lambda e:callback('https://feastables.com/'))
