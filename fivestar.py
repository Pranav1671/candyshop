...
lb3=Label(win1,text='MRP  : Rs. 20.00 /-',font=('copper',20,'bold'))
lb3.place(x=360,y=30)
lb4=Label(win1,text='Expiry Date  : SEP/23 ',font=('copper',20,'bold'))
...
btt1.bind('<Button-1>',lambda e:callback('https://www.cadbury.co.za/product/cadbury-5star'))
